...
const Sidebar = () => {
  return (
      <Card className={styles.sidebar}>
        <Flex direction="column" gap="lg" className={styles.layout}>
              <Group>
                ...
                <Timeline.Item bullet={<IconBellSchool size={14} />} fz="xs" title="Предупредительный сигнал">
                    <Text c="dimmed" size="xs">Через 8 секунд подайте сигнал человеку</Text>
                </Timeline.Item>
            ...
            <Button color="green" className={styles.ringBtn} leftSection={<IconBellSchool size={24} />}>Подать сигнал</Button>
        </Flex>
    </Card>
  )
}
