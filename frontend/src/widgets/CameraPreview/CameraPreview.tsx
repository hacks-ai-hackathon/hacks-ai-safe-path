...
const CameraPreview = ({ cameraName }: Props) => {
  return (
      <Card className={styles.preview} padding="0" radius="md">
          <Flex direction="column" gap="sm" className={styles.layout}>
            ...
            <iframe
                ...
                src="https://www.youtube.com/embed/g7CJ3pm-e7s?si=NAJzGUFhbCKVGMJP&autohide=1&showinfo=0&controls=0&mute=1&autoplay=1&hd=1"
                frameBorder="0"
                allow="autoplay"
            />
          </Flex>
